...
namespace Infoscreen_Verwaltung.classes
{
    public class Anzeige
    {
        ...
        static public string Menue(string _Ebene, string dir)
        {
            ...
            if (Login.Rechte.Bildschirme.OneBiggerThan(1)) temp += "<a href='" + _Ebene + "admin/theme/'>Farbschema</a>\r\n";
            if (Login.Rechte.Bildschirme.OneBiggerThan(1)) temp += "<a href='" + _Ebene + "admin/function-config/'>Erweitert</a>\r\n";
